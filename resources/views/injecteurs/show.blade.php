        ...
        <section class="section-tours">
            <div class=" text-center  u-margin-bottom-medium">
                <br>  <br>  <h2 class="heading-secondary">
                    <small>Fiche client:</small> {{$injecteur->client}}
                </h2>
            </div>
            <div class="row">
                 <div class="col-2-of-4" style="margin: 2% 25%">
                     <div class="card">
                        <div class="card__side card__side--front">
                            ...
                            <h4 class="card__heading">
                                <span class="card__heading-span card__heading-span--2">FICHE INJECTEUR CLIENT</span>
                            ...
                            <div class="card__details">
                                <ul>
                                    ...
                                    <li>Avis technicien: {{$injecteur->avis_technicien}}</li>
                                    <li>Debut de tache : {{$injecteur->debut_tache}}</li>
                                    <li>Fin de tache : {{$injecteur->fin_tache}}</li>
                        ...
                        <div class="card__side card__side--back card__side--back-2">
                            <div class="card__cta">
                                ...
                                <a href="{{ route('injecteurs.edit', [$injecteur->id]) }}" class="btn btn--white">Avis / Diagnostic</a>
                                                    <!-- /injecteurs/{{$injecteur -> id}}/edit -->
                                @else
                                <a href="{{ route('injecteurs.edit', [$injecteur->id]) }}" class="btn btn--white">Modifier tache</a>
                                @endif
                            </div>
                        </div>
                    </div>
