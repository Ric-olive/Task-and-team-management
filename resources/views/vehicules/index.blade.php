...
<head>
    ...
    <title>{{ config('app.name', 'DESG Reception Vehicule') }}</title>
        ...
        <section class="section-tours">
            <div class=" text-center  u-margin-bottom-medium">
                <br>  <br>  <h2 class="heading-secondary">
                    LISTE RECEPTION VEHICULE
                </h2>
                @if(Auth::user()->role == 'admin')
        <div class="text-right" ><a style="float: right;margin-right: 15px" href="{{ route('vehicules.create') }}"><span class="flaticon-add-1">Creer</span></a></div>
        @endif
                <br>  <br>
            </div>
            <div class="row">
                     ...
                     <div class="card">
                        <div class="card__side card__side--front">
                            ...
                            <h4 class="card__heading">
                                <span class="card__heading-span card__heading-span--2">DESG FICHE vehicule</span>

                            </h4>
                            <div class="card__details">
                                <ul>
                                    <li>Client:{{$vehicule->client}}</li>
                                    <li>Date:{{$vehicule->date_entree}}</li>
                                    <li>Reference:{{$vehicule->reference}}</li>
                                    <li>Avis client:{{$vehicule->avis_client}}</li>
                                </ul>
                            </div>
                        </div>
                        <div class="card__side card__side--back card__side--back-2">
                            <div class="card__cta">
                                ...
                                <a href="/vehicules/{{$vehicule ->id}}" class="btn btn--white">Voir Details</a>
                            </div>
                        </div>
                    </div>
                </div> -->
